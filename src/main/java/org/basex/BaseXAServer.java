 ...
 * @author Dirk Kirsten
 */
public final class BaseXAServer extends Main {
   ...
   */
  public BaseXAServer(final String... args) throws IOException {
    this(null, args);
  }
   ...
   * @throws IOException I/O exception
   */
  public BaseXAServer(final Context ctx, final String... args) throws IOException {
    super(args, ctx);
